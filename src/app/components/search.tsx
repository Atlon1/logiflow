...
export const Search = () => {
    ...
    return (
        <div
            ...
            <div className={`flex h-full ${searchActive ? 'justify-between' : 'justify-center'}`}>
                <LocationSelection/>
                <DateSelection/>
                <HoursSelection/>
                <div className='xl:h-full flex items-center px-6 xl:px-0'>
                    <button className={`${searchActive ? 'btn btn-sm btn-accent w-[164px]' : 'btn btn-sm btn-accent xl:w-[184px]'}`}>Serach</button>
                </div>
            </div>
        </div>
    )
